...
const inst_descriptions = {
    ...
    0x06: i => i('jumpEqual', 14, { idx: i.zero(2).ui(2), val: i.zero(2).ui(4), label: i.label() }),
    0x08: i => i('jumpGtEql', 14, { idx: i.zero(2).ui(2), val: i.zero(2).ui(4), label: i.label() }),
    0x09: i => i('jumpLtEql', 14, { idx: i.zero(2).ui(2), val: i.zero(2).ui(4), label: i.label() }),
    ...
    0xba: i => i('0xba', 2, {}),
    0xbb: i => i('volumeAnim_bb', 6, { volume: i.zero(1).ui(1), duration: i.ui(4) }),
    0xbc: i => i('volumeAnim_bc', 6, { volume: i.ui(1), duration: i.zero(1).ui(4) }),
    0xbd: i => i('volumeAnim_bd', 6, { volume: i.zero(1).ui(1), duration: i.ui(4) }),
    0xbe: i => i('volumeAnim_be', 6, { volume: i.zero(1).ui(1), duration: i.ui(4) }),
...
if (module) module.exports = { disassemble, assemble };
